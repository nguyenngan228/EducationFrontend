      ...
      try {
        let res = await APIs.post(
          ...
          qs.stringify({
            username: username,
            password: password,
            client_id: "thMx8SMwbvnC73PlfERMHVD8dEhIwj3Qgd8yYfjs",
            client_secret:
              "Q0UWUGSuIe00jhu9EfQ1JREM6I6TLX9udAgE8xdTu0G0Jo3eHtWfcRnPkNwVAkJlFNQNfz4AEQUTFPGwDmvxtCzWMtIFgmoJF0yQG5R8lea3nnIOkubRDEFgEgALqRot",
            grant_type: "password",
          }),
          {
            headers: {
